...
sudo apt-get install osmosis nodejs python-virtualenv python-pip apache2 git # You may need a later version of nodejs if you run into a "Method not found error"
